...
4. Create your own S3 bucket. Go to the AWS S3 console, click the Create bucket button. Choose a publicly visible and unique name for your bucket. Select the region closest to your data source. Keep all the default settings and click the Create bucket button. Since the s3://udacity-dend/ data is located in us-west-2, I am also creating my S3 bucket in the same region.
